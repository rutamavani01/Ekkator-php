          ...
          <div class="id-card div-sc-two">
            ...
            <div class="dv-sc-four">
              ...
              <div class="icard">
                ...
                <span class="icard_st_dt"><?php echo e(get_phrase('Removed')); ?> </span>
                <?php else: ?>
              ...
              <div class="icard">
                ...
                <?php if(empty($student_details->section_name)): ?>
                <span class="icard_st_dt"><?php echo e(get_phrase('Removed')); ?> </span>
                <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\Ekattor8\resources\views/admin/student/id_card.blade.php ENDPATH**/ ?>