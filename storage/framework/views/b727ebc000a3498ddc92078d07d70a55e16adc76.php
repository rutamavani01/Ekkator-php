...
<div class="eForm-layouts">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm"
        ...
        <div class="row fmb-14 justify-content-between align-items-center">
            <label for="name" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Additional information')); ?></label>
            <div class="col-sm-10 col-md-9 col-lg-10">
...
</div><?php /**PATH C:\xampp\htdocs\Ekattor8\resources\views/admin/offline_admission/single_student_admission.blade.php ENDPATH**/ ?>