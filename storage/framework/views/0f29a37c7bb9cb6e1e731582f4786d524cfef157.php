...
<form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('accountant.fee_manager.update', ['id' => $invoice_details->id])); ?>">
	<?php echo csrf_field(); ?> 
	<div class="form-row">
		<div class="fpb-7">
...
</script><?php /**PATH C:\xampp\htdocs\Ekattor8\resources\views/accountant/student_fee_manager/edit.blade.php ENDPATH**/ ?>