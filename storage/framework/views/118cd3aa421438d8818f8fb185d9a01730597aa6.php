      ...
      <ul class="nav-links">
        ...
        <li class="nav-links-li <?php echo e(request()->is('admin/exam_category*') || request()->is('admin/offline_exam*') || request()->is('admin/marks') || request()->is('admin/grade') || request()->is('admin/promotion*') ? 'showMenu':''); ?>">
            ...
            <ul class="sub-menu">
                ...
                <!-- admit card -->
                <li>
                    <a class="<?php echo e((request()->is('admin/promotion*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.promotion')); ?>"><span><?php echo e(get_phrase('Admit Card')); ?></span></a>
                </li>

                <!-- Print Admit Card -->
                  <li>
                    <a class="<?php echo e((request()->is('admin/promotion*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.promotion')); ?>"><span><?php echo e(get_phrase(' ')); ?></span></a>
                </li>
...
<?php /**PATH C:\xampp\htdocs\Ekattor8\resources\views/admin/navigation.blade.php ENDPATH**/ ?>