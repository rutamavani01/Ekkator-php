<div class="eForm-layouts">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('superadmin.faq_create')); ?>">
        <?php echo csrf_field(); ?>
        <div class="form-row">
            <div class="fpb-7">
...
</div><?php /**PATH C:\xampp\htdocs\Ekattor8\resources\views/superadmin/settings/add_faq.blade.php ENDPATH**/ ?>