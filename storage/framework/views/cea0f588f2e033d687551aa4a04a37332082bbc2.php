<div class="eForm-layouts">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('admin.accountant.update', ['id' => $user->id])); ?>">
         <?php echo csrf_field(); ?> 
        <div class="form-row">
            <div class="fpb-7">
            ...
            <div class="fpb-7">
                ...
                <input type="text" class="form-control eForm-control" value="<?php echo e($info->phone); ?>" id="phone" name = "phone" placeholder="Provide accountant number" required>
            </div>
            <div class="fpb-7">
...
</script><?php /**PATH C:\xampp\htdocs\Ekattor8\resources\views/admin/accountant/edit_accountant.blade.php ENDPATH**/ ?>