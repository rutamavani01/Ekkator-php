      ...
      <ul class="nav-links">
        ...
        <li class="nav-links-li <?php echo e(request()->is('admin/book*') || request()->is('admin/book_issue*') || request()->is('admin/noticeboard*') || request()->is('admin/subscription') || request()->is('admin/events/list*') ? 'showMenu':''); ?>">
            ...
            <ul class="sub-menu">
                ...
                <li>
                    <a class="<?php echo e((request()->is('admin/complain/complainList*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.complain.complainList')); ?>"><span><?php echo e(get_phrase('Complain List')); ?>
...
<?php /**PATH D:\xampp\htdocs\ekattor8_v9\Ekattor8\resources\views/admin/navigation.blade.php ENDPATH**/ ?>